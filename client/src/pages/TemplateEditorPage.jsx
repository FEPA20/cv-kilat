...
const spellIssues = useMemo(() => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900">
      <header className="sticky top-0 z-30 flex h-20 items-center border-b border-slate-200 bg-white px-5 shadow-sm lg:px-8">
        <button
          type="button"
          onClick={() => onBack(data)}
          className="rounded-2xl text-left transition hover:bg-slate-50 focus:outline-none focus:ring-4 focus:ring-sky-100"
          aria-label="Kembali dari Editor Desain"
        >
          <LogoCVKilat
            theme="light"
            compact
